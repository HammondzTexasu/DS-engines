...
```text
/
├── index.html              # Rozcestník design systému (redirect na color-engine)
└── color-engine/
    ├── color-engine.md     # Specifikace modulu
    ├── src/
    │   ├── engine.js       # Logika interpolace a generování barev
    │   └── state.js        # Výchozí stav a export/import konfigurace
    ├── hct/
